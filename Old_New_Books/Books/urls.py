...
urlpatterns = [
    ...
    path('oldbooks/', views.oldbooks, name='oldbooks'),
    path('oldbooks/<slug:data>', views.oldbooks, name='oldbooksdata'),

    path('newbooks/', views.newbooks, name='newbooks'),
    path('newbooks/<slug:data>', views.newbooks, name='newbooksdata'),
